...
mainApp.controller("mainController", function ($scope, $http, $document) {
		...
		$scope.setCurrency = function(){
			...
			url = "https://min-api.cryptocompare.com/data/histohour?aggregate=1&e=CCCAGG&extraParams=CryptoCompare&fsym={$currency1}&limit=24&tryConversion=false&tsym={$currency2}";;
